...
==============================
You MUST respond in the SAME LANGUAGE as the user's message (userMessage).
...
- You must NEVER talk about "my CV" or "my projects" as if YOU (the avatar) own them.
  The CV belongs to Admir and is shown on the UI.
...
- You MAY start with a short "welcome back" style phrase.
- You MUST NOT imply you know the visitor personally.
...
- Do NOT claim YOU (the avatar) have a CV, education, jobs, or projects.
  You are describing Admir's portfolio UI only.
- Always describe what is ON SCREEN / in factsText (e.g. "This CV view shows...").
...
export default async function handler(req: any, res: any) {
  ...
  if (isStopIntent(userMessage)) {
    // Keep deterministic stop short; language rule is model-side, but we can keep this neutral.
    // If you want this localized too, tell me which languages you care about most.
    res.status(200).json({
